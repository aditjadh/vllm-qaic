...
def main(log_path):
    ...
    with open(log_path, "w") as f:
        ...
        try:
            ...
            # D > 512 AND USE_DEFAULT_FLA_NORM=1 -> l2norm_fwd_kernel1 (per-row)
            T, D = 16, 1024
            ...
            log(f"  USE_DEFAULT_FLA_NORM=1, D>512 => l2norm_fwd_kernel1")
            log("")
...
if __name__ == "__main__":
    run_test(main, LOG_DIR, "l2norm_fwd_kernel1")
