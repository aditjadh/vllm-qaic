...
DEVICE = "qaic"
KERNEL_NAME = "_per_token_group_quant_fp8_colmajor"
...
def main(log_path):
    ...
    with open(log_path, "w") as f:
        ...
        try:
            ...
            log(f"  column_major_scales=True, use_ue8m0=False")
            log("")
            ...
            x_q, x_s = per_token_group_quant_fp8(
                x, group_size, column_major_scales=True, use_ue8m0=False
            )
...
if __name__ == "__main__":
    run_test(main, LOG_DIR, "per_token_group_quant_fp8_colmajor")
